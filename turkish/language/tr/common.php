...
$lang = array_merge($lang, array(
	...
	'DOWNLOAD_ALL_ATTACHMENTS'	=> 'Tüm eklentileri indir',
	...
	'NOTIFICATION_BOOKMARK'				=> array(
		1	=> 'Sık kullanılanlara eklediğiniz “%2$s” başlığına %1$s cevap yazdı.',
	),
	'NOTIFICATION_GROUP_REQUEST'		=> '%1$s %2$s grubuna katılmak için istek gönderdi.',
	'NOTIFICATION_GROUP_REQUEST_APPROVED'	=> '%1$s grubuna katılma isteğiniz onaylandı.',
	'NOTIFICATION_PM'					=> '%1$s size "%2$s" başlıklı bir Özel Mesaj gönderdi.',
	'NOTIFICATION_POST'					=> array(
		1	=> '%1$s “%2$s” başlığına cevap yazdı.',
	),
	'NOTIFICATION_POST_APPROVED'		=> '"%2$s" başlıklı mesajınız onaylandı.',
	'NOTIFICATION_POST_DISAPPROVED'		=> '"%1$s" başlıklı mesajınız onaylanmadı. Sebep: "%2$s".',
	'NOTIFICATION_POST_IN_QUEUE'		=> '%1$s tarafından "%2$s" başlığına yeni bir mesaj gönderildi ve onaylanması gerekiyor.',
	'NOTIFICATION_QUOTE'				=> array(
		1	=> '%1$s “%2$s” mesajı içerisinde sizin mesajınızı alıntı yaptı.',
	),
	'NOTIFICATION_REPORT_PM'			=> '%1$s "%2$s" başlıklı bir Özel Mesajı bildirdi. Sebep: "%3$s".',
	'NOTIFICATION_REPORT_POST'			=> '%1$s "%2$s" başlıklı bir mesajı bildirdi. Sebep: "%3$s".',
	'NOTIFICATION_REPORT_CLOSED'   		=> '%1$s "%2$s" mesajı için yaptığınız bildiriyi kapattı.',
	'NOTIFICATION_TOPIC'				=> '%1$s "%3$s" forumu içerisinde "%2$s" konulu yeni bir başlık açtı.',
	'NOTIFICATION_TOPIC_APPROVED'		=> '"%3$s" forumu içerisindeki "%2$s" konulu başlığınız onaylandı.',
	'NOTIFICATION_TOPIC_DISAPPROVED'	=> '"%1$s" konulu başlığınız onaylanmadı. Sebep: "%2$s".',
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> '%1$s tarafından "%2$s" konulu yeni bir başlık açıldı ve onaylanması gerekiyor.',
	'NOTIFICATION_TYPE_NOT_EXIST'		=> '"%s" bildirim tipi dosya sisteminde mevcut değil.',
	'NOTIFICATION_ADMIN_ACTIVATE_USER'	=> '“%1$s” kullanıcı hesabı yeni kayıt edildi ve aktivasyon gerekiyor.',
	...
	'NO_AVATAR_SELECTED'		=> 'Herhangi bir avatar seçmediniz.',
